...
<main class="main-content">
   <div id="main-slider" class="main-slider">
      ...
      <div class="item">
         ...
         <img src="{{ asset('assets/images/noimage.png') }}" width="1349" height="516" alt="No image found!">
         @else
               ...
               <div class="release-book-slider">
                  ...
                  <div class="item">
                     ...
                     <div class="detail-img">
                        ...
                        <img src="{{ asset('assets/images/noimage.png') }}" width="112" height="156" alt="{{ $upcoming->title }}">
                        @else
                        <img src="{{ asset('uploads') }}/{{ $upcoming->book_img }}" width="112" height="156" alt="{{ $upcoming->title }}">
                        @endif
                     </div>
                  </div>
                  @endforeach
               ...
               <ul id="release-thumb" class="release-thumb">
                  ...
                  <li>
                     <a data-slide-index="{{ $key }}" href="#">
                        ...
                        @if($upcoming->book_img == 'No image found')
                        <img src="{{ asset('assets/images/noimage.png') }}" width="94" height="122" alt="{{ $upcoming->title }}">
                        @else
                        <img src="{{ asset('uploads') }}/{{ $upcoming->book_img }}" width="94" height="122" alt="{{ $upcoming->title }}">
                        @endif
                     </a>
                  </li>
                  @endforeach 
                     ...
                     <div class="item">
                        <div class="product-box">
                           <div class="product-img">
                              ...
                              <img src="{{ asset('assets/images/noimage.png') }}" width="132" height="197" alt="{{ $downloaded->title }}">
                              @else
                              <img src="{{ asset('uploads') }}/{{ $downloaded->book_img }}" width="132" height="197" alt="{{ $downloaded->title }}">
                              @endif
                           ...
                           <div class="product-detail">
                              ...
                              <div class="aurthor-detail">
                                 <span><img src="{{ asset('path') }}assets/images/book-aurthor/img-01.jpg" alt="">{{ $downloaded->author->title ?? '' }}</span>
      ...
      <div class="container">
         ...
         <div class="recomend-slider">
            ...
            <div class="item">
               ...
               <img src="{{ asset('assets/images/noimage.png') }}" width="109" height="150" alt="{{ $recommend->title }}">
               @else
               <a href="#"><img src="{{ asset('uploads') }}/{{ $recommend->book_img }}" width="109" height="150" alt="{{ $recommend->title }}"></a>
               @endif
            </div>
            <!-- Item -->
            @empty
                           ...
                           <li>
                              <div class="s-product">
                                 <div class="s-product-img">
                                    ...
                                    <img src="{{ asset('assets/images/noimage.png') }}" width="145" height="209" alt="No image found!">
                                    @else
                                    <img src="{{ asset('uploads') }}/{{ $book->book_img }}" width="145" height="209" alt="{{ $book->fullname }}">
                                    @endif
      ...
      <div class="row">
         ...
         <div class="col-lg-3 col-sm-12">
            <div class="aurthor-img">
               ...
               <img src="{{ asset('assets/images/noimage.png') }}" width="243" height="344" alt="No image found!">
               @else
               <img src="{{ asset('uploads') }}/{{ $author_feature->author_feature_img }}" width="243" height="344" alt="{{ $author_feature->title }}">
               @endif
            </div>
         </div>
                  ...
                  <li id="1985">
                     <div class="text-box">
                        ...
                        <ul class="s-related-products">
                           <li>
                              @if($book->book_img == 'No image found')
                              <img src="{{ asset('assets/images/noimage.png') }}" width="89" height="119" alt="No image found!">
                              @else
                              <img src="{{ asset('uploads') }}/{{ $book->book_img }}" width="89" height="119" alt="{{ $book->title }}">
                              @endif
      ...
      <div class="row">
         ...
         <div class="col-lg-4 col-xs-12">
            ...
            <div class="blog-style-1">
               <div class="post-box">
                  <div class="thumb"><img src="{{ asset('path') }}assets/images/blog/img-01.jpg" alt=""></div>
                  ...
                  <div class="post-box">
                     <div class="thumb"><img src="{{ asset('path') }}assets/images/blog/img-02.jpg" alt=""></div>
                     ...
                     <div class="post-box">
                        <div class="thumb"><img src="{{ asset('path') }}assets/images/blog/img-03.jpg" alt=""></div>
                        ...
                        <ul>
                           ...
                           <li>
                              <div class="gallery-figure">
                                 ...
                                 <img src="{{ asset('assets/images/noimage.png') }}" width="242" height="187" alt="No image found!">
                                 @else
                                 ...
                                 <div class="overlay">
                                    <ul class="position-center-x">
                                       ...
                                       <li><a href="{{ asset('assets/images/gallery/img-01.jpg') }}" data-rel="prettyPhoto[gallery]"><i class="fa fa-plus"></i></a></li>
                                    </ul>
                                 </div>
                              </div>
                           </li>
