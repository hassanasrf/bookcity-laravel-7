                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <img src="/uploads/{{ $team->team_img }}" width="100" alt="No Image">
                                    @endif
                                </td>
                                <td>
                                    <form name="statusForm" id="statusForm" method="post" action="/admin/team/{{ $team->id }}/status">
                                    @csrf
                                    {{ method_field('put') }}
                                ...
                                <td>
                                    <form name="deleteForm" id="deleteForm" method="post" action="/admin/team/{{ $team->id }}">
                                    @csrf
                                    {{ method_field('delete') }}
