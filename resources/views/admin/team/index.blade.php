                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            ...
                            <a href="{{ asset('admin/team/create') }}" class="btn btn-default btn-xm"><i class="fa fa-plus"></i></a>
                        </h3>
                        <div class="box-tools">
                            <form method="get" action="{{ asset('admin/team') }}">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <img src="{{ asset('uploads') }}/{{ $team->team_img }}" width="100" alt="No Image">
                                    @endif
                                </td>
                                <td>
                                    <form name="statusForm" id="statusForm" method="post" action="{{ asset('admin/team') }}/{{ $team->id }}/status">
                                    @csrf
                                    {{ method_field('put') }}
                                ...
                                <td>
                                    <form name="deleteForm" id="deleteForm" method="post" action="{{ asset('admin/team') }}/{{ $team->id }}">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <a href="{{ asset('admin/team') }}/{{ $team->id }}/edit" class="btn btn-info btn-flat btn-sm"> <i class="fa fa-edit"></i></a>
